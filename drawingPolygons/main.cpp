...
int main(void)
{
    ...
    char const * vertexSource = loadShaderSource("./resources/shaders/drawingPolygons/vertexShader.vert");
    ...
    char const * fragmentSource = loadShaderSource("./resources/shaders/drawingPolygons/fragmentShader.frag");
