...
int main(void)
{
    ...
    char const * vertexSource = loadShaderSource("./resources/shaders/textures/vertexShader.vert");
    ...
    char const * fragmentSource = loadShaderSource("./resources/shaders/textures/fragmentShader.frag");
